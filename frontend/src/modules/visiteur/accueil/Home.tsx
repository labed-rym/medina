...
function Home(): ReactElement {
  ...
  const imageData: Array<{ src: string; path: string }> = [
    { src: "/images/Algeria (1) (1).jpg", path: "/recherche/Wilaya" },
    { src: "/images/Constantine-Algeria (1).jpg", path: "/recherche/categorie" },
    { src: "/images/download (11) (1).jpg", path: "/recherche/periode" }
  ];
  ...
  const handleVoirTousClick = (): void => {
    navigate('/recherche'); // Navigate to the search page
  };
