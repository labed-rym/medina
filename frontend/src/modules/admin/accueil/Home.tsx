...
function Hoome(): ReactElement {
  ...
  const imageData: Array<{ src: string; path: string }> = [
    { src: "/images/Algeria (1) (1).jpg", path: "/recherche/Wilayaa" },
    { src: "/images/Constantine-Algeria (1).jpg", path: "/recherche/categoriea" },
    { src: "/images/download (11) (1).jpg", path: "/recherche/periodea" }
  ];
  ...
  const handleVoirTousClick = (): void => {
    navigate('/recherchea'); // Navigate to the search page
  };
